...
if __name__ == '__main__':
    ...
    parser.add_argument('-dataset_name', type=str, required=True,
                        choices=['arabic', 'google_speech_v0.01', 'google_speech_v0.02',
                                 'audio_mnist', 'voxceleb1', 'voxceleb2'],
    ...
    parser.add_argument('-gender', type=str, default='mix',
                        choices=['mix', 'female', 'male'])
    ...
    if args.eval:
        ...
        if args.dataset_name not in ['voxceleb1', 'voxceleb2']:
            ...
            if args.pretrained_model:
                ...
                print('Load Param:', sum(param.numel()
        ...
        if args.stage == 2:
            ...
            if args.dataset_name not in ['voxceleb1', 'voxceleb2']:
                ...
                if args.tune_threshold:
                    ...
                    tuned_threshold = json.load(open(
                        '/'.join(args.init_model.split('/')[:-1]) + configs['Pairs']['threshold_path']))
                for gender in eval_info:
                    ...
                    json.dump(results, open(
                        folder_cfgs['run_path'] + '/all_eval_results_tuning_2.json', 'w'))

                    if args.tune_threshold:
                        json.dump(threshold_store, open(
                            folder_cfgs['run_path'] + '/eval_thresholds.json', 'w'))
            else:
