...
if __name__ == '__main__':
    ...
    parser.add_argument('-dataset_name', type=str, default='audio_mnist',
    ...
    parser.add_argument('-info_data', type=str,
                        default='./meta_data/stage2/split_0.5_stage2.json', help='path to info of data')
    ...
    parser.add_argument(
        '-stage', type=int, choices=[1, 2], default=2, help='use {1:accuracy,2:eer} to evaluate')
    ...
    if args.pretrained_model is not None:
        ...
        model.load_parameters(args.pretrained_model)
        # m = torch.load(args.pretrained_model, map_location=param_cfgs['device'])
        # print(sum(param.numel() for param in m.parameters()) / 1024 / 1024)
        # model.speaker_encoder = m
    else:
        epoch = 1
